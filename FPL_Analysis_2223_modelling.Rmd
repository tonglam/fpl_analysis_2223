...
predict <- as.numeric(predict(tmodel, newdata=tree_train_data_1, type = "class"))

print(calcAUC(predict, tree_train_data_1[, target]))

predict <- as.numeric(predict(tmodel, newdata=tree_test_data_1, type = "class"))


pp <- prediction(predict, tree_test_data_1[, target])


print(calcAUC(predict, tree_test_data_1[, target]))
