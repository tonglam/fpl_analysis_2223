...
tmodel_1 <- rpart(player_type ~., data=tree_train_data_1, method = 'class')

trainPredictions <- predict(tmodel_1, newdata=tree_train_data_1, type = "class")
...
testPredictions <- predict(tmodel_1, newdata=tree_test_data_1, type = "class")
...
pred_train_roc <- predict(tmodel_1, newdata = train_data)
pred_test_roc <- predict(tmodel_1, newdata = test_data)

plot_roc(pred_train_roc[, 1],
