...
```
- Conclusion:
The result shows 6 of the features have similar score by AUC. "pred_expected_goal_involvements_per_90" is the highest AUC score.
...
select_cat_result
```
The result from categorical, penalties_order ...low deviance...,highest AUC(train0.56/test0.61).... 这里对上面这个数据写个结论，主要是结合前面的auc进行描述一下。
