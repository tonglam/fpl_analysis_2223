...
fpl_data %>%
  ...
  geom_density(fill = "#69b3a2",
               ...
               alpha = 0.6) +
  xlim(0, 300) + 
  ggtitle("Points distribution of players who played more than 1000 minutes") +
  theme_ipsum() +
...
server <- function(input, output) {
  ...
  blox <- function(plot_data) {
    plot_data %>%
      ...
      geom_boxplot() +
      stat_summary(fun.y = mean, geom = "point", shape = 20, size = 10, color = "#ec7014", fill = "#ec7014") +
...
type_choices <- max(fpl_data$Goals)
...
server <- function(input, output) {
  ...
  output$plot <- renderPlot({
    ...
    #TODO add a title, include the player num, textGrob = "Compare players number:";adjust the height
