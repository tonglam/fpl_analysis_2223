...
# if a player did not finish 90 minutes in total for an entire seson
# compare their values of per 90 make no sense
performance_data$Minutes <-
  ifelse(performance_data$Minutes < 90, NA, performance_data$Minutes)
