...
# reshape data here, make a n*3 data frame to 2n*2, wide to long
performance_data <- fpl_data %>%
  select(
    c(
      "Position",
      "Cost",
...
server <- function(input, output) {
  ...
  output$plot <- renderPlot({
    ...
    # if (grep("Goals", types)) {
    #   print("Goals")
    #   plot_list <- append(plot_list, goals_plot())
    # }
    # if (grep("Assists", types)) {
    #   print("Assists")
    #   plot_list <- append(plot_list, assists_plot())
    # }
    # if (grep("GC", types)) {
    #   print("GC")
    #   plot_list <- append(plot_list, gc_plot())
    # }
    # if (grep("CS", types)) {
    #   print("CS")
    #   plot_list <- append(plot_list, cs_plot())
    # }
